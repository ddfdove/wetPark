<template>
    ...
    <ul id="left">
        <li>
            ...
            <el-popover placement="left-start" :width="400" trigger="click" :show-arrow="false" :offset="400" popper-class="popperClass">
                <template #reference>
                    <div>
                        <h3 style="padding: 15px 0 15px 60px; font-size: 16px; margin-bottom: 10px;">数据采集</h3>
                        <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
                            <el-tab-pane v-for="(item, index) in tabsList" :key="index" :label="item.label"
                                ...
                                <el-table :data="tableData" :max-height="240" :header-row-style="headerRowStyle"
                                    ...
                                    <el-table-column v-for="(tableItem, index) in item.tableList" :key="index"
                                        :prop="tableItem.prop" :label="tableItem.label1" width="140" />
                                </el-table>
                            </el-tab-pane>
                        </el-tabs>
                    </div>
        ...
        <li style="background-color: rgb(18,39,57); opacity: 1;">
            <p style="font-size: 22px; font-weight: 500; color: rgb(60,191,223);margin:0 0 10px 30px;">地点检测</p>
            <div class="top" style="display: flex;margin-bottom: 30px; ">
                <div class="tLeft" style="flex:1 ">
                    <el-dropdown @command="handleCommand">
                        <span class="el-dropdown-link">
                            <span style="margin-right: 50px;">西岸5号</span><el-icon
    ...
    <div id="device">
        <div class="dTop">
            ...
            <i class="iconfont icon-shouye_"
                style="font-size: 36px; padding-left: 20px;color: white;font-weight: 600;"></i>
            <!-- <i class="iconfont icon-shidigongyuan" style="font-size: 36px; padding-left: 20px;color: white;font-weight: 600;"></i> -->
            <span style="font-size: 30px; color: white;font-weight: 400;opacity: 0.8;padding-left: 20px;">园区名</span>
        </div>
        <div class="dMiddle">
            <video-player :src="videoSrc" :options="playerOptions" :volume="0.6" />
        </div>
        <div class="dBottom">
            <h2 style="padding-left: 20px;color: white;font-weight: 600;opacity: 0.5;">描述</h2>
            <p style="padding: 10px 50px;color: #FFFFFF;margin: 10px 0;">海湖湿地公园位于西宁市海晏路绿地云香郡北侧,是一个集湿地保育、科普宣教、合理利用、管理服务等
                多功能于一体的湿地生态展示示范基地
            </p>
            <button style="height: 70px;width: 240px;margin-left: 60px;font-size: 18px;">进入设备</button>
        </div>
    </div>
</template>
