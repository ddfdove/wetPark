...
import { keyMap, colorMap, keyToChineseMap, getIndicators, formatDate } from '@/utils/mapping.js'
...
const updateChartOptions = (dataList, categories, isExcellent) => {
  ...
  chartOptions.value.tooltip.pointFormatter = function () {
    ...
    return `<b>${chineseName}</b>&nbsp&nbsp&nbsp&nbsp${this.y}&nbsp&nbsp&nbsp&nbsp ${status.value}<br> `;
  };
  //标题
