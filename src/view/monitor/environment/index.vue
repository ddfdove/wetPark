  ...
  <div class="container">
    <div class="left">
      ...
      <panelboard :chTitle="'水质监测'" :enTitle="'Water quality Monitoring'">
        <ul>
          <li>
            <div class="chart-container soil">
              <AreaChart :dataList="{ waterPHList }" :categories="waterCollectTimeList" :isExcellent="isWaterExcellent">
              </AreaChart>
            </div>
          </li>
          <li>
            <div class="chart-container hydrology">
              <BarChart :dataList="{ waterTemperatureList }" :categories="waterCollectTimeList"
          ...
          <li>
            <div class="chart-container water">
              <PieChart :dataList="{ waterTurbidityList }" :categories="waterCollectTimeList"
                :isExcellent="isWaterExcellent"></PieChart>
            </div>
          </li>
        </ul>
      </panelboard>
    ...
    <div class="middle">
      ...
      <div class="environment">
        <button class="moreButton" @click=" $router.push({ path: '/data/environment' })">
          <i class="iconfont icon-gengduoshuangjiantou" style="font-size: 12px;margin-right: 8px;"></i>
          <span>MORE</span>
        </button>
    ...
    <div class="right">
      <button class="moreButton" @click=" $router.push({ path: '/data/soil' })">
        <i class="iconfont icon-gengduoshuangjiantou" style="font-size: 12px;margin-right: 8px;"></i>
        <span>MORE</span>
      </button>
      <panelboard :chTitle="'土壤监测'" :enTitle="'Soil monitoring'">
        <ul>
          <li>
            <div>
              <AreaChart :dataList="{ soilPHList }" :categories="soilCollectTimeList" :isExcellent="isSoilExcellent">
              </AreaChart>
            </div>
          </li>
          <li>
            <div>
              <PyramidChart :dataList="{ soilMoistureList }" :categories="soilCollectTimeList"
                :isExcellent="isSoilExcellent"></PyramidChart>
            </div>
          </li>
...
const mappingEnv = (envData) => {
  ...
  pm25List.value = envData.pm25List;
}
