...
import { restorePosition } from "./position";
class MeasureTool {
  ...
  drawLineMeasureGraphics(options = {}) {
    if (this._viewer && options) {
      ...
      _handlers.setInputAction(function (movement) {
        const resPosition = restorePosition(movement.position);
        var cartesian = $this.getCatesian3FromPX(resPosition);
      ...
      _handlers.setInputAction(function (movement) {
        const resPosition = restorePosition(movement.endPosition);
        var cartesian = $this.getCatesian3FromPX(resPosition);
    ...
    // console.log('this._drawLayer.entities',this._drawLayer.entities)
    // console.log('this._drawLayer',this._drawLayer)
